  ...
  return (
    ...
    >
      <div className="relative z-10">
        <h1 className="hero-enter mb-4 font-display text-[clamp(56px,11vw,108px)] font-extrabold leading-[0.88] tracking-[-0.055em] text-[#111]">
          langdon
          <br />
          <span className="font-light text-[#8a8a86]">huynh</span>
        </h1>
        <p className="hero-enter hero-enter-2 mb-6 text-[11px] font-semibold uppercase tracking-[3px] text-[#999]">
      ...
      <div className="relative flex items-center justify-center">
        ...
        <div className="hero-enter hero-enter-3 relative z-10 h-[200px] w-[200px] overflow-hidden rounded-full border border-black/10 shadow-[0_16px_48px_rgba(0,0,0,0.14)] sm:h-[240px] sm:w-[240px]">
          <Image
            src="/headshot.png"
            alt="Langdon Huynh"
            fill
